function toNumberArray(arr){
    ...
    for(let i =0;i<arr.length;i++){
        strConvertToNum.push(+[arr[i]])

    }
    return strConvertToNum;

}
function toNumberArray(arr){
   const convertToNum = arr.map(x=> +x)
   return convertToNum;

}
function toNumberArray(arr){
   const convertToNum = arr.map(x=> Number(x))
   return convertToNum;

}
function toNumberArray(arr){
   const convertToNum = arr.map(x=> parseFloat(x))
   return convertToNum;
